...
export const ENVIRONMENTS: Record<EnvironmentType, EnvironmentConfig> = {
  ...
  [EnvironmentType.SPACE]: { 
    name: 'חלל', backgroundColor: '#050505', fogColor: '#000000', fogDensity: 0.005, 
    ambientIntensity: 0.2, accentColor: '#6a0dad', gravity: [0, 0, 0], 
    allowFlight: true, description: 'מרחבי החלל האינסופיים', linearDamping: 0.01
  },
  [EnvironmentType.VOID]: { 
    name: 'ריק', backgroundColor: '#1a1a1a', fogColor: '#000000', fogDensity: 0.08, 
    ambientIntensity: 0.5, accentColor: '#ff0055', gravity: [0, -4, 0], 
    allowFlight: false, description: 'הריק המוחלט', linearDamping: 0.05
  }
};
