...
export const ENVIRONMENTS: Record<EnvironmentType, EnvironmentConfig> = {
  ...
  [EnvironmentType.AIR]: { 
    ...
    gravity: [0, 0, 0],
    allowFlight: true,
    description: 'מרומי השמיים הפתוחים',
    linearDamping: 0.02
  },
  [EnvironmentType.SPACE]: { 
    ...
    gravity: [0, 0, 0], 
    allowFlight: true,
    description: 'מרחבי החלל האינסופיים',
    linearDamping: 0.01
  },
